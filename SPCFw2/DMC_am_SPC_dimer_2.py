...
Spring 2024
----------------------------------------------------------------------------------------------
Enter `DMC_am_SPC_dimer_2.py` into the terminal to run DMC on the system of the water dimer
with the SPC/Fw model of water, on the second specified set of parameters. 
...
def position(count):
    ...
    pos[:, 1] = np.random.normal(10, 0.5, pos[:, 1].shape)
