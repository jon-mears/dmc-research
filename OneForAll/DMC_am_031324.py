...
recommended system parameters. NOTE: The classes Walkers and DMC will normally be put in a 
separate file.
'''
...
def diffusionFunction(walkers):
    ...
    arr[:, :, c] += np.random.normal(0.0, np.sqrt(timeStep/walkers.atomic_mass('c')), arr[:, :, c].shape)
