...
DMC_am_TIP4_dimer_2.py
CS446 -- DMC Research
Spring 2024
----------------------------------------------------------------------------------------------
Enter `DMC_am_TIP4_dimer_2.py` into the terminal to run DMC on the system of the water dimer
with the TIP4 model of water, and the second specified set of parameters. 
