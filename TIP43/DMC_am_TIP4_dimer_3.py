...
DMC_am_TIP4_dimer_3.py
CS446 -- DMC Research
Spring 2024
----------------------------------------------------------------------------------------------
Enter `DMC_am_TIP4_dimer_3.py` into the terminal to run DMC on the system of the water dimer
with the TIP4 model of water, and the third specified set of parameters. 
...
def position(count):
    ...
    pos[:, 1] = np.random.normal(3, 0.5, (count, 6))
