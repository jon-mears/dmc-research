...
Spring 2024
----------------------------------------------------------------------------------------------
Enter `DMC_am_SPC_dimer_1.py` into the terminal to run DMC on the system of the water dimer
with the SPC/Fw model of water, on the first specified set of parameters. 
